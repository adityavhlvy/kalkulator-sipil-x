    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-900 to-gray-900 p-8 text-white">
            <div className="bg-gray-800 p-8 rounded-xl shadow-2xl border border-gray-700">
                <h1 className="text-3xl font-bold text-blue-400 mb-6">Analisis Free Span</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        <label className="block text-blue-300 text-sm font-semibold mb-2">
                            Tegangan Geser Pada Bagian Pertama, Vrc1 (Pa)
                        </label>
                        <input
                            type="number"
                            step="0.001"
                    ...
                    <div>
                        <label className="block text-blue-300 text-sm font-semibold mb-2">
                            Tegangan Geser Pada Bagian Kedua, Vrc2 (Pa)
                        </label>
                        <input
                            type="number"
                            step="0.001"
                    ...
                    <div>
                        <label className="block text-blue-300 text-sm font-semibold mb-2">
                            Tegangan Geser Pada Titik Sumbu, Us (Pa)
                        </label>
                        <input
                            type="number"
                            step="0.001"
                    ...
                    <div>
                        <label className="block text-blue-300 text-sm font-semibold mb-2">
                            Tegangan Geser Pada Titik Defleksi, Ud (Pa)
                        </label>
                        <input
                            type="number"
                            step="0.001"
