...
export default function Home() {
  ...
  const cards = [
    ...
    },
    {
      ...
      description: "Perhitungan untuk menentukan ukuran atau ketebalan pipa bagian luar.",
    },
    {
      href: "/kalkulator-4",
      imageSrc: imageExample.src,
      title: "Kalkulator Analisis Free-Span",
      description: "Perhitungan untuk menentukan berat beton coating yang dibutuhkan agar pipa tetap berada pada posisi yang stabil.",
    },
  ];
